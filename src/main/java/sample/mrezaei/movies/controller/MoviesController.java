...
public class MoviesController {
    ...
    @Operation(summary = "Get popular movies", description = "Returns list of popular movies.")
    @GetMapping("popular")
    ...
    @Operation(summary = "Search in movies", description = "Returns the list of movies searched by query and sorted and filtered if needed.")
    @GetMapping("search")
    ...
    @Operation(summary = "Find movie by id", description = "Returns detailed single movies information")
    @GetMapping("{id}")
